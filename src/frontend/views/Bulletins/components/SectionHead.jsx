        ...
        <div className="flex flex-col lg:flex-row md:items-center justify-between gap-4 ">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              {`Bulletins de notes ${
                showAllBulletins ? " - " + NomClasse : ""
              }`}
            </h1>
          </div>
          <div className="flex gap-x-5">
            <button
              disabled={showAllBulletins}
              onClick={previewAllBulletins}
              className="flex items-center justify-center space-x-2 px-4 py-2 bg-gray-600 text-white rounded-md w-fit hover:bg-gray-700 disabled:text-gray-500 disabled:bg-gray-800 transition-colors duration-200"
            >
              <ChartColumnBigIcon className="w-4 h-4" />
