...
const SingleBulletin = ({
  ...
  async function fetchEleveInfo() {
    try {
      ...
      if (currentEleve) setBulletinExists(true);
  ...
  if (!bulletinExists)
    return (
      <section>
        {" "}
        L'élève {eleve.Nom} {eleve.Prenoms} n'a aucune note pour cette période.
        Son bulletin n'est donc pas disponible.{" "}
      </section>
    );
      ...
      <div className="flex justify-between items-center content-center text-center border-b border-black px-2 py-3">
        ...
        <div>
          <div className="flex justify-center items-center gap-x-1">
            ...
            <span className="block text-md uppercase">République du Bénin</span>{" "}
            <span className="block w-5 h-4 benin-flag relative">
              <img
                className="w-full h-full"
                src="app://resources/images/default/benin_flag.png"
