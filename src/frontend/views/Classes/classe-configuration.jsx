      ...
      <Modal isOpen={openModal} onClose={closeModal} title="Nouveaux cours">
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex-1 space-y-2">
                <div>
                  ...
                  <select
                    ...
                    value={ens.CodMat}
                    className="h-10 p-2 mt-1 block w-full outline-none rounded-md border-[2px] border-gray-300 shadow-sm outline-none focus:outline-none outline-none focus:border-blue-500 outline-none focus:ring-blue-500"
                    required
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block h-10 p-2 outline-none w-full rounded-md border-[2px] border-gray-300 shadow-sm outline-none focus:outline-none outline-none focus:border-blue-500 outline-none focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    className="h-10 p-2 mt-1  outline-none block w-full rounded-md border-[2px] border-gray-300 shadow-sm outline-none focus:outline-none outline-none focus:border-blue-500 outline-none focus:ring-blue-500"
                    required
                  >
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="px-4 py-2 outline-none focus:ring-0 outline-none  bg-blue-600 text-white rounded-md hover:bg-blue-700"
