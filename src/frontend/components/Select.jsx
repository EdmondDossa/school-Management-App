...
const Select = ({
  ...
  const variantStyles = {
    default:
      "bg-white border-gray-300 hover:border-gray-400 focus:border-blue-500 focus:ring-blue-500",
    primary:
      "bg-blue-50 border-blue-300 hover:border-blue-400 focus:border-blue-600 focus:ring-blue-600",
    success:
      "bg-green-50 border-green-300 hover:border-green-400 focus:border-green-600 focus:ring-green-600",
    danger:
      "bg-red-50 border-red-300 hover:border-red-400 focus:border-red-600 focus:ring-red-600",
  };
